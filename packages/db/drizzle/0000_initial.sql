...
CREATE TABLE "credential_generations" (
	...
	CONSTRAINT "credential_generations_expiration" CHECK ("credential_generations"."expiration" IS NULL OR "credential_generations"."expiration" >= 0),
...
CREATE TABLE "ledger_checkpoints" (
	...
	CONSTRAINT "ledger_checkpoints_index" CHECK ("ledger_checkpoints"."ledger_index" >= 0),
	...
	CONSTRAINT "ledger_checkpoints_close_time" CHECK ("ledger_checkpoints"."close_time" >= 0),
...
CREATE INDEX "pin_challenges_expiry_idx" ON "pin_challenges" USING btree ("expires_at");--> statement-breakpoint
...
CREATE INDEX "schemas_publisher_order_idx" ON "schemas" USING btree ("profile_id","publisher","ledger_index","transaction_index");
