...
[ADR 0005](../adr/0005-nuxt-api-boundary.md) implements the transport boundary only; the role-based
ADR 0004 (`docs/adr/0004-role-based-application.md`), prepared concurrently for
