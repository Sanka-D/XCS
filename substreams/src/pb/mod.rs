// @generated (XRPL types) + manually extended (xcs types)
pub mod google {
...
pub mod sf {
    ...
    pub mod xrpl {
        pub mod r#type {
            // @@protoc_insertion_point(attribute:sf.xrpl.type.v1)
            pub mod v1 {
                include!("sf.xrpl.type.v1.rs");
                // @@protoc_insertion_point(sf.xrpl.type.v1)
            }
        }
    }
}
